...
def create_bw_color_pairs():
    ...
    for i, (color_image, label) in enumerate(train_loader, 0):
        ...
        torchvision.utils.save_image(grayscale_image, f'../data/bw_images/bw_image_{i}.png')
        torchvision.utils.save_image(color_image, f'../data/color_images/color_image_{i}.png')
